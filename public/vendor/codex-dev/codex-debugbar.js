...
(function (codex) {
    ...
    (function (debugbar) {
        debugbar.app = {};
        debugbar.$ = PhpDebugBar.$;
        debugbar.createCodeBlock = PhpDebugBar.Widgets.createCodeBlock;
        debugbar.csscls = PhpDebugBar.utils.makecsscls('phpdebugbar-widgets-');
        debugbar.prefix = debugbar.csscls('codex');
        debugbar.DebugBar = PhpDebugBar.DebugBar;
        var Color;
        (function (Color) {
            Color[Color["Red"] = 0] = "Red";
            Color[Color["LightRed"] = 1] = "LightRed";
            Color[Color["DarkRed"] = 2] = "DarkRed";
            Color[Color["Pink"] = 3] = "Pink";
            Color[Color["LightPink"] = 4] = "LightPink";
            Color[Color["DarkPink"] = 5] = "DarkPink";
            Color[Color["Purple"] = 6] = "Purple";
            Color[Color["LightPurple"] = 7] = "LightPurple";
            Color[Color["DarkPurple"] = 8] = "DarkPurple";
            Color[Color["DeepPurple"] = 9] = "DeepPurple";
            Color[Color["LightDeepPurple"] = 10] = "LightDeepPurple";
            Color[Color["DarkDeepPurple"] = 11] = "DarkDeepPurple";
            Color[Color["Indigo"] = 12] = "Indigo";
            Color[Color["LightIndigo"] = 13] = "LightIndigo";
            Color[Color["DarkIndigo"] = 14] = "DarkIndigo";
            Color[Color["Blue"] = 15] = "Blue";
            Color[Color["LightBlue"] = 16] = "LightBlue";
            Color[Color["DarkBlue"] = 17] = "DarkBlue";
            Color[Color["Cyan"] = 18] = "Cyan";
            Color[Color["LightCyan"] = 19] = "LightCyan";
            Color[Color["DarkCyan"] = 20] = "DarkCyan";
            Color[Color["Teal"] = 21] = "Teal";
            Color[Color["LightTeal"] = 22] = "LightTeal";
            Color[Color["DarkTeal"] = 23] = "DarkTeal";
            Color[Color["Green"] = 24] = "Green";
            Color[Color["LightGreen"] = 25] = "LightGreen";
            Color[Color["DarkGreen"] = 26] = "DarkGreen";
            Color[Color["Lime"] = 27] = "Lime";
            Color[Color["LightLime"] = 28] = "LightLime";
            Color[Color["DarkLime"] = 29] = "DarkLime";
            Color[Color["Yellow"] = 30] = "Yellow";
            Color[Color["LightYellow"] = 31] = "LightYellow";
            Color[Color["DarkYellow"] = 32] = "DarkYellow";
            Color[Color["Amber"] = 33] = "Amber";
            Color[Color["LightAmber"] = 34] = "LightAmber";
            Color[Color["DarkAmber"] = 35] = "DarkAmber";
            Color[Color["Orange"] = 36] = "Orange";
            Color[Color["LightOrange"] = 37] = "LightOrange";
            Color[Color["DarkOrange"] = 38] = "DarkOrange";
            Color[Color["DeepOrange"] = 39] = "DeepOrange";
            Color[Color["LightDeepOrange"] = 40] = "LightDeepOrange";
            Color[Color["DarkDeepOrange"] = 41] = "DarkDeepOrange";
            Color[Color["Brown"] = 42] = "Brown";
            Color[Color["LightBrown"] = 43] = "LightBrown";
            Color[Color["DarkBrown"] = 44] = "DarkBrown";
            Color[Color["Grey"] = 45] = "Grey";
            Color[Color["LightGrey"] = 46] = "LightGrey";
            Color[Color["DarkGrey"] = 47] = "DarkGrey";
        })(Color || (Color = {}));
        ...
        debugbar.Item = Item;
        debugbar.defaultConfig = {};
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
var codex;
(function (codex) {
    var debugbar;
    (function (debugbar) {
        ...
        (function (lib) {
            function contentType(name) {
                return function (cls) {
                    var contentType = new cls;
                    debugbar.app['content.types'].register(name, contentType);
                };
            }
            lib.contentType = contentType;
            var ContentTypeRepository = (function () {
                function ContentTypeRepository() {
                    this.types = {};
                }
                ContentTypeRepository.prototype.register = function (name, contentType) {
                    this.types[name] = contentType;
                };
                ContentTypeRepository.prototype.get = function (name) {
                    if (!this.has(name)) {
                        throw new Error('ContentTypeRepository does not have ' + name);
                    }
                    return this.types[name];
                };
                ContentTypeRepository.prototype.has = function (name) {
                    return typeof this.types[name] !== "undefined";
                };
                return ContentTypeRepository;
            }());
            lib.ContentTypeRepository = ContentTypeRepository;
            var TextContentType = (function () {
                function TextContentType() {
                }
                TextContentType.prototype.render = function (item) {
                    return item.value;
                };
                return TextContentType;
            }());
            lib.TextContentType = TextContentType;
            var CodeContentType = (function () {
                function CodeContentType() {
                }
                CodeContentType.prototype.render = function (item) {
                    var args = [item.value];
            ...
            lib.CodeContentType = CodeContentType;
            var ArrayContentType = (function () {
                function ArrayContentType() {
                }
                ArrayContentType.prototype.render = function (item) {
                    console.log('array content type', item);
                    return item.value;
                };
                return ArrayContentType;
            }());
            lib.ArrayContentType = ArrayContentType;
        })(lib = debugbar.lib || (debugbar.lib = {}));
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
var codex;
(function (codex) {
    ...
    (function (debugbar) {
        ...
        (function (util) {
            ...
            util.Config = Config;
        })(util = debugbar.util || (debugbar.util = {}));
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
var codex;
(function (codex) {
...
(function (codex) {
    ...
    (function (debugbar) {
        var lib;
        (function (lib) {
            debugbar.app['content.types'] = new lib.ContentTypeRepository;
            debugbar.app['content.types'].register('text', debugbar.app['content.types.text'] = new lib.TextContentType);
            debugbar.app['content.types'].register('code', debugbar.app['content.types.code'] = new lib.CodeContentType);
            debugbar.app['content.types'].register('array', debugbar.app['content.types.array'] = new lib.ArrayContentType);
        })(lib = debugbar.lib || (debugbar.lib = {}));
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
var codex;
(function (codex) {
    ...
    (function (debugbar) {
        var listeners = {};
        function listenToDebugBar(fname, cb) {
            if (typeof listeners[fname] === 'undefined') {
                listeners[fname] = [];
            }
            listeners[fname].push(cb);
        }
        debugbar.listenToDebugBar = listenToDebugBar;
        function fireListener(fname, obj, args) {
            if (args === void 0) { args = []; }
            if (typeof listeners[fname] !== 'undefined') {
                listeners[fname].forEach(function (cb) {
                    cb.apply(obj, args);
                });
            }
        }
        function initListeners() {
            var fnames = ['setHeight', 'resize', 'render', 'showTab', 'last'];
            var extension = {};
            ...
            fnames.forEach(function (fname) {
                if (fname === 'last') {
                    PhpDebugBar.DebugBar = PhpDebugBar.DebugBar.extend(extension);
                    return;
                }
        ...
        (function (phpdebugbar) {
            ...
            var Widget = (function () {
                function Widget() {
                    ...
                    debugbar.$.each(myPrototype, function (propertyName, value) {
                ...
                ;
                Widget.prototype.set = function (attr, value) {
                    if (attr === void 0) { attr = {}; }
                    if (value === void 0) { value = {}; }
                };
                ;
                Widget.prototype.has = function (attr) {
                    return undefined;
                };
                ;
                ...
                ;
                Widget.prototype.bindAttr = function (attr, cb) {
                };
                ;
                return Widget;
            }());
            phpdebugbar.Widget = Widget;
        })(phpdebugbar = debugbar.phpdebugbar || (debugbar.phpdebugbar = {}));
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
var codex;
(function (codex) {
    ...
    (function (debugbar) {
        var elements;
        (function (elements) {
            var $body = debugbar.$('body');
            var tpls = {
                tabs: function (cls) {
                    return debugbar.$("\n            <div class=\"tabbable " + cls + "\">\n                <ul class=\"nav nav-tabs\" role=\"tablist\">\n                </ul>\n                <div class=\"tab-content\">\n                </div>\n            </div>\n            ");
                },
                tab: function (id, text) {
            ...
            (function (TabSide) {
                TabSide[TabSide["TOP"] = 0] = "TOP";
                TabSide[TabSide["RIGHT"] = 1] = "RIGHT";
                TabSide[TabSide["BOTTOM"] = 2] = "BOTTOM";
                TabSide[TabSide["LEFT"] = 3] = "LEFT";
            })(elements.TabSide || (elements.TabSide = {}));
            var TabSide = elements.TabSide;
            var Tabs = (function () {
                function Tabs(side) {
                    this.$panels = debugbar.$();
                    this.$tabs = debugbar.$();
                    this.tabs = {};
                ...
                Tabs.prototype.getSideClass = function (side) {
                    var str = 'tabs-' + TabSide[side];
                    return str.toLocaleLowerCase();
                };
                Tabs.prototype.addTab = function (id, name) {
            ...
            var Tab = (function () {
                function Tab(tabs, id, name) {
                    ...
                    this.$tab.on('show.bs.tab', function (e) {
                        _this.tabs.$nav.find('li > a').removeClass('active');
                        debugbar.$(e.target).addClass('active');
                    });
                }
                Tab.prototype.show = function () {
                ...
                Tab.prototype.hider = function (sdf, asdfsafd) {
                };
                return Tab;
            }());
            elements.Tab = Tab;
        })(elements = debugbar.elements || (debugbar.elements = {}));
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
var codex;
(function (codex) {
    var debugbar;
    (function (debugbar) {
        var CodexWidget = (function (_super) {
            __extends(CodexWidget, _super);
            function CodexWidget() {
                _super.apply(this, arguments);
                this.className = debugbar.prefix;
            }
            CodexWidget.prototype.initialize = function (options) {
                this.set(options);
            };
            CodexWidget.prototype.render = function () {
                var _this = this;
                this.bindAttr('data', function (data) {
                    _this.$panel = _this.$el.parent();
                    _this.items = data.debugbar;
                    _this.tabs = new debugbar.elements.Tabs(debugbar.elements.TabSide.LEFT);
                    _this.tabs.$el.appendTo(_this.$el);
                    _this.items.forEach(function (item) {
                        var tab = _this.tabs.addTab(item.id, item.name);
                        var content = debugbar.app['content.types'].get(item.type).render(item);
                        tab.$panel.append(content);
                    });
                    _this.$panel.data('codex', _this);
                    _this.resize();
                    debugbar.listenToDebugBar('setHeight.after', function (height) {
                        _this.resize();
                    });
                });
            };
            CodexWidget.prototype.resize = function () {
                this.$el.height(this.$panel.height() - 2);
            };
            CodexWidget = __decorate([
                debugbar.phpdebugbar.widget('CodexWidget')
            ], CodexWidget);
            return CodexWidget;
        }(debugbar.phpdebugbar.Widget));
        debugbar.CodexWidget = CodexWidget;
    })(debugbar = codex.debugbar || (codex.debugbar = {}));
})(codex || (codex = {}));
